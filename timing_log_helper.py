...
"""This client generates the csv which is imported into R in order to
create the timing graph as shown in the report Evaluation section.
The timing lists are generated by the PokerSequencer class by enabling the 
DEBUG_TIMINGS flag"""
